...
final class GraphQLDocumentUtil {
  static String getDataQueryDocument({
      ...
      '''
        query GetDataQuery {
          getData {
            ...
            ${fields == null || fields.contains(enums.Field.hash) || fields.contains(enums.Field.position) ? closingCurlyBrace : emptyString}
  ...
  static String getHistoryQueryDocument({
    List<enums.Field>? fields,
  }) =>
      '''
